...
logging.basicConfig(filename=r'C:\users\vamsi\desktop\logs\stockchecker3070.log', encoding='utf-8', level=logging.DEBUG, format='%(asctime)s %(message)s', datefmt='%m/%d/%Y %I:%M:%S %p')
...
subject = "RPTech RTX 3070 Stock Available!!!"
message_text_html  = r'Hi<br/>RTX 3070 is available <b> <br/> https://rptechindia.in/nvidia-geforce-rtx-3070.html</b>'
