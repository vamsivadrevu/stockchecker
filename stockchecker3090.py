...
logging.basicConfig(filename=r'C:\users\vamsi\desktop\logs\stockchecker3090.log', encoding='utf-8', level=logging.DEBUG, format='%(asctime)s %(message)s', datefmt='%m/%d/%Y %I:%M:%S %p')
toaster = win10toast.ToastNotifier()

URL = "https://rptechindia.in/nvidia-geforce-rtx-3090.html"

return_status = "nope"

to = "masked@gmail.com"
sender = "masked@gmail.com"
subject = "RPTech RTX 3090 Stock Available!!!"
message_text_html  = r'Hi<br/>RTX 3090 is available <b> <br/> https://rptechindia.in/nvidia-geforce-rtx-3090.html</b>'
