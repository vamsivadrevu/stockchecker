...
logging.basicConfig(filename=r'C:\users\vamsi\desktop\logs\stockchecker3080.log', encoding='utf-8', level=logging.DEBUG, format='%(asctime)s %(message)s', datefmt='%m/%d/%Y %I:%M:%S %p')
toaster = win10toast.ToastNotifier()

URL = "https://rptechindia.in/nvidia-geforce-rtx-3080.html"

return_status = "nope"

to = "masked@gmail.com"
sender = "masked@gmail.com"
subject = "RPTech RTX 3080 Stock Available!!!"
