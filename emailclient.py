...
def get_credentials():
    ...
    if not credentials or credentials.invalid:
        CLIENT_SECRET_FILE = 'client_secret_644114465009-movmliedcuutbbtls9egl40u40l0n3o0.apps.googleusercontent.com.json'
        APPLICATION_NAME = 'PythonMailer'
...
def create_message_and_send(sender, to, subject, message_text_html):
...
def create_message_without_attachment (sender, to, subject, message_text_html):
...
def main():
    ...
    subject = "RPTech Stock Available!!!"
    message_text_html  = r'Hi<br/>RTX 3080 is available <b> <br/>https://rptechindia.in/nvidia-geforce-rtx-3080.html</b>'
    #message_text_plain = "Hi\nPlain Email"
    #attached_file = r'C:\Users\Me\Desktop\audio.m4a'
    create_message_and_send(sender, to, subject, message_text_html)
